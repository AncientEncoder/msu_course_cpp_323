...
namespace uni_course_cpp {
    GraphPath GraphTraverser::find_shortest_path(
        ...
        const int vertices_count = graph_.getVertices().size();
        ...
        std::vector<int> previous_ids(vertices_count, UNDEFINED_ID);
        ...
        while (!queue.empty()) {
            ...
            for (const auto& vertex_id :
                    graph_.getConnectedVertexId(current_vertex_id)) {
        ...
        const auto path = [&destination_vertex_id, &source_vertex_id,
            ...
            int vertex_id = destination_vertex_id;
